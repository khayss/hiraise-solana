export function EnterIcon({ width = "1em" }: { width?: string }) {
  return (
...
export function DonateIcon({ width = "1em" }: { width?: string }) {
  return (
...
export function CreateCampaignIcon({ width = "1em" }: { width?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} viewBox="0 0 24 24">
      <path
        fill="currentColor"
